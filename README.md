...
Welcome to my pet project. I decided to try to design a solution to combat climate change, to answer the question **"Could reversing climate change even be done regardless of the budget with existing technology?"** What would such a solution even look like? Here's my attempt. I've called it The Modern Druid Project. This is based on Canadian climates as I live in Canada, but should be applicable to every climate zone warm enough to grow plants, the specific plants would just change. 

### **Executive Summary (Read This First)**
**What it is.** A replicable, open‑source **carbon‑removal farm** that pairs **syntropic agroforestry** (biomass + free food) with **biochar** (durable CDR), verified by rigorous **0–3 m soil** and **kiln emissions** MRV, funded by **carbon credits + biochar sales**, and governed by an **equitable pay + land‑transfer model** that trains crews to **spawn new farms**. And by giving every farm a new farm financing budget, we can achieve exponential growth.

**How it works.** We grow layered food forests and high‑biomass coppice alleys. Part of the biomass becomes **biochar** (durable credits sold for revenue); soils simultaneously gain **biogenic carbon** (soil credits). At least **half the char stays on‑farm** to accelerate fertility, water resilience, and future biomass. Food is **free pick‑your‑own** to remove logistics friction and deliver community benefits immediately.

**Why this wins.** The system compounds: **better soils → more biomass → more char/credits → more investment in soils and irrigation**, on a workforce model that **prioritizes wages (50% of revenue)** and **transfers land** to workers over time. Every profitable farm **spawns more farms**, with a fixed revenue share devoted to financing new farms, which in turn spawn new farms and so on. Exponential growth while paying fairly, providing genuine prosperity and free food to communities everywhere. The carbon markets are international, so if this can be made to work in a place as expaensive as Canada, it can work throughout the developing world as well, and for the same wages, immune to all but the most targetted political opposition. The ability to expand beyond borders with minimal changes, making the same wages everywhere.
...
But if our atmosphere increases by even 10 ppm from the thawing permafrost, not even pulling a teraton of carbon dioxide out of the atmosphere over the next few decades would save humanity from extinction this century. So timing is important here, as in we need to scale up carbon dioxide removal before enough permafrost melts and rots that the methane levels spike. 10 ppm of methane would be roughly equivalent to 550 ppm of carbon dioxide, on top of the 140 ppm we are currently over by. If that happens in the next decade, not many children alive today live to see 50. Time is of the essence.
...
And all of that by gardening like a beast, having fancy bonfires and daring to solve the problem. Pick your own damn food.